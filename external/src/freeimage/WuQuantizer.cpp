...
void WuQuantizer::Hist3D(LONG *vwt, LONG *vmr, LONG *vmg, LONG *vmb, float *m2, int ReserveSize, RGBQUAD *ReservePalette)
{
	int ind = 0;
...
void WuQuantizer::M3D(LONG *vwt, LONG *vmr, LONG *vmg, LONG *vmb, float *m2)
{
	unsigned ind1, ind2;
	BYTE i, r, g, b;
...
LONG WuQuantizer::Vol(Box *cube, LONG *mmt)
{
...
LONG WuQuantizer::Bottom(Box *cube, BYTE dir, LONG *mmt)
{
	switch (dir)
	{
	case FI_RGBA_RED:
...
LONG WuQuantizer::Top(Box *cube, BYTE dir, int pos, LONG *mmt)
{
	switch (dir)
	{
	case FI_RGBA_RED:
...
float WuQuantizer::Var(Box *cube)
{
	...
	float xx = gm2[INDEX(cube->r1, cube->g1, cube->b1)] - gm2[INDEX(cube->r1, cube->g1, cube->b0)] - gm2[INDEX(cube->r1, cube->g0, cube->b1)] + gm2[INDEX(cube->r1, cube->g0, cube->b0)] - gm2[INDEX(cube->r0, cube->g1, cube->b1)] + gm2[INDEX(cube->r0, cube->g1, cube->b0)] + gm2[INDEX(cube->r0, cube->g0, cube->b1)] - gm2[INDEX(cube->r0, cube->g0, cube->b0)];
...
float WuQuantizer::Maximize(Box *cube, BYTE dir, int first, int last, int *cut, LONG whole_r, LONG whole_g, LONG whole_b, LONG whole_w)
{
...
void WuQuantizer::Mark(Box *cube, int label, BYTE *tag)
{
